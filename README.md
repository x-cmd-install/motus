...
Total: **1,373** lines of code across **13** files in the top 5 languages.
...
- **Upstream**: <https://github.com/oleiade/motus>
- **License**: AGPL-3.0
...
- **Stars**: 157 · **Forks**: 9 · **Open issues**: 10 · **Contributors**: 7

## Totals (cumulative)

- **Releases**: 6 · **Merged PRs**: 49 · **Open PRs**: 1 · **Closed issues**: 8 · **Open issues**: 2 · **Commits**: 188
...
Reported by **4** distros on [repology.org](https://repology.org/project/motus). **3** are ✅ on the latest upstream release, **1** are ⚠️ on an older version.
...
_Snapshot: `data/card/260911.yml` · 2026-09-11T04:34:20Z._
