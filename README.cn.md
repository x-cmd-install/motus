...
[![x-cmd/install — motus Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/motus.svg?lang=zh)](https://x-cmd.com/install/motus)
...
合计: **1,373** 行代码（覆盖前 5 种语言、共 **13** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 1,120 | 68 | 195 | 4 |
| Toml | 131 | 4 | 18 | 6 |
| Makefile | 105 | 27 | 34 | 1 |
| Html | 13 | 0 | 2 | 1 |
| Json | 4 | 0 | 0 | 1 |

## 源代码

- **上游仓库**: <https://github.com/oleiade/motus>
- **许可证**: AGPL-3.0
...
- **Star**: 157 · **Fork**: 9 · **开放 issue**: 10 · **贡献者**: 7

## 累计统计

- **发布数**: 6 · **已合并 PR**: 49 · **开放 PR**: 1 · **已关闭 issue**: 8 · **开放 issue**: 2 · **提交数**: 188
...
| 90d | 2026-06-28 | 1 | 4 | 1 | 0 | 0 | 11 |
| last180d | 2026-03-30 | 1 | 11 | 1 | 0 | 1 | 21 |
| 360d | 2025-10-01 | 1 | 40 | 1 | 2 | 2 | 60 |
| last720d | 2024-10-06 | 4 | 48 | 1 | 5 | 2 | 151 |
...
motus 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `motus` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/motus.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T04:58:51Z._
